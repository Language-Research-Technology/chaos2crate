...
import { createPlugin as create_3 } from "c2c-plugins/src/chat-export/index.js";
import { createPlugin as create_4 } from "c2c-plugins/src/merge/index.js";
import { createPlugin as create_5 } from "c2c-plugins/src/validate-crate/index.js";
import { createPlugin as create_6 } from "c2c-plugins/src/ro-crate-json-output/index.js";
import { createPlugin as create_7 } from "c2c-plugins/src/ro-crate-xlsx-output/index.js";
import { createPlugin as create_8 } from "c2c-plugins/src/ro-crate-html-output/index.js";
...
export const PLUGINS = [
  ...
  create_3(deps), // chat-export
  create_4(deps), // merge
  create_5(deps), // validate-crate
  create_6(deps), // ro-crate-json-output
  create_7(deps), // ro-crate-xlsx-output
  create_8(deps), // ro-crate-html-output
];
