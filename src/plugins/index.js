...
// Selected plugins (PLUGINS=all): xlsx-crate-input, austlang, file-format-identify, ca-data-prep, chat-export, merge, validate-crate, ro-crate-json-output, ro-crate-xlsx-output, ro-crate-html-output
...
import { createPlugin as create_6 } from "c2c-plugins/src/validate-crate/index.js";
import { createPlugin as create_7 } from "c2c-plugins/src/ro-crate-json-output/index.js";
import { createPlugin as create_8 } from "c2c-plugins/src/ro-crate-xlsx-output/index.js";
import { createPlugin as create_9 } from "c2c-plugins/src/ro-crate-html-output/index.js";
...
export const PLUGINS = [
  ...
  create_5(deps), // merge
  create_6(deps), // validate-crate
  create_7(deps), // ro-crate-json-output
  create_8(deps), // ro-crate-xlsx-output
  create_9(deps), // ro-crate-html-output
];
